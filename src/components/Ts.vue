...
const varFunction: {} = () => {};
        ...
        <div class="row">
          <div class="col-sm-12">
            <h4>function with array param</h4>
          </div>
        </div>
        <pre class="pre">
...
varFunctionArray(['one', 'two', 'three']);
        ...
        <div class="row">
          <div class="col-sm-12">
            <h4>function with object param</h4>
          </div>
        </div>
        <pre class="pre">
